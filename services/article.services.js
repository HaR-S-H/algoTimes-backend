...
export async function fetchAndSaveNews(query) {
  try {
    ...
    const url = `https://newsapi.org/v2/everything?q=${encodeURIComponent(query)}&pageSize=100&page=2&language=en&sortBy=publishedAt&apiKey=${process.env.NEWS_API_KEY}`;
